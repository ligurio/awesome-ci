...
|[Chrono CI](https://www.chronoci.com/) | Hosted platform for testing & finding code vulnerabilities | Languages: Ruby on Rails, Node.js | GitHub | [Documentation](https://www.chronoci.com/docs) | [Free for 100 tests per month](https://www.chronoci.com/pricing) |
...
|[Rocro INSPECODE](https://rocro.com/) | CReview less, move faster. Speed up your software development with Inspecode’s continuous code inspection and automated code correction. | Languages: Java, JavaScript, C, C++, Python, Ruby, PHP, Go, Scala, TypeScript, Clojure and more... | GitHub, BitBucket | [Documentation](https://inspecode.rocro.com/help/) | [Free with limitations](https://rocro.com/inspecode/pricing) |
